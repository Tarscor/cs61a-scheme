...
(define a (cons 'cdr '('(1 append '(2) '(3)))))

a
; expect (cdr (quote (1 append (quote (2)) (quote (3)))))

(eval a)
; expect (append (quote (2)) (quote (3)))
...
(begin (define a 2) (define b (* a 3)) (define c (* a b)))
; expect c
...
((lambda (x y) (define x 0) (list x y)) 4 5)
; expect (0 5)

(begin (define a 1) (define b 2) (define (f a c) (lambda () (+ a b c))))
; expect f
...
(or (even? 3) (define a 5) (define b 2))
; expect a
...
(and (or (and) (or)) (or (even? 3) (< -1 0)))
; expect #t


;;; Cond

(cond ((and 0 (= 1 2)) 'Not returned)
      ((begin (define a 1) (odd? 2)) 'Not returned)
      ((or False nil) a)
      (else 'Not reached))
; expect 1

(define x (cond ((begin (define a 1) (define b 2) False) 'Untrue)
                ((lambda (y) (+ a b)))
                (else None)))
; expect x
...
(begin (define a 1) (define b 1) (define c 1))
...
(let ((a 2) (b (* 2 a)) (c (* 2 b))) (list a b c))
; expect (2 2 2)
